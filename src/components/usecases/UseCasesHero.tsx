    ...
    <section className="relative pt-32 pb-20 px-6 md:px-12 max-w-[1920px] mx-auto overflow-hidden">
      ...
      <div className="text-center max-w-4xl mx-auto">
        <motion.div
          ...
          className="inline-block mb-4 px-4 py-1.5 rounded-full bg-accent/10 text-accent text-sm font-bold uppercase tracking-widest"
        >
          Advertising 3.0
        </motion.div>
        ...
        >
          DOOH dinamico, contestuale e misurabile tramite mobilità robotica.
        </motion.p>
      </div>
